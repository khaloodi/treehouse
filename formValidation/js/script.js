...
const languageValidator = () => {
  ...
  var languageSectionIsValid = languageTotal > 0;
...
//  e.preventDefault();
  ...
  if (!nameValidator()) {
    e.preventDefault();
    console.log('Name validator prevented submisson');
  ...
  if (!emailValidator()) {
    e.preventDefault();
    console.log('Email validator prevented submisson');
    // If `(!nameValidator())` call `e.preventDefault();` 
      // And log out a message saying this particular validator prevented submission
  } 
  ...
  if (!languageValidator()) {
    e.preventDefault();
    console.log('Language validator prevented submisson');
    // If `(!nameValidator())` call `e.preventDefault();` 
      // And log out a message saying this particular validator prevented submission
  } 
